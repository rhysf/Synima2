...
* Version 2 is entirely rewritten in the rust programming language. Bringing refinements in bringing the whole pipeline under a single program. Several other updates, including refined ability to the Create_sequence_dictionary step to automatically identify and match files.

## Prerequisites
To build and run Synima, you’ll need:
